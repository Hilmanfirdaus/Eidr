...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const char GENESIS_COINBASE_TX_HEX[] =
            "012801ff000180c0f4c198af0b022638ef42e6354443a55d32e32a8556fcad238538e17165cf6b0e4b5c3b965364210173e4c9f55015387b6c0d04e64567ce42b91a75d9da5b5cbaaf49e1910e91783b";
        ...
        /* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
           You can get this value by doing "print_block 2" in NinjaCoind. It is used to know what timestamp
           to import from when the block height cannot be found in the node or the node is offline. */
        const uint64_t GENESIS_BLOCK_TIMESTAMP = 1554129297;
        ...
        const uint64_t TRANSACTION_SIGNATURE_COUNT_VALIDATION_HEIGHT = 950000;

        const uint64_t BLOCK_BLOB_SHUFFLE_CHECK_HEIGHT = 950000;

        const uint64_t TRANSACTION_INPUT_BLOCKTIME_VALIDATION_HEIGHT = 950000;
        ...
        const size_t NORMAL_TX_MAX_OUTPUT_COUNT_V1_HEIGHT = 950000;
