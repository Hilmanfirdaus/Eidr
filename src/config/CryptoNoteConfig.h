...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 10115542401;  //Ninja1
...
const uint64_t LWMA_3_DIFFICULTY_BLOCK_INDEX                 = 350000;
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "012801ff000180c0f4c198af0b022638ef42e6354443a55d32e32a8556fcad238538e17165cf6b0e4b5c3b965364210173e4c9f55015387b6c0d04e64567ce42b91a75d9da5b5cbaaf49e1910e91783b";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1552311570;
...
const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 350000;
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 350000;
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 350000;
...
const uint32_t FUSION_DUST_THRESHOLD_HEIGHT_V2               = 350000;
...
const uint32_t UPGRADE_HEIGHT_V4                             = 1000000000; // Upgrade height for CN-Lite Variant 1 switch.
const uint32_t UPGRADE_HEIGHT_V5                             = 1000000000; // Upgrade height for CN-Turtle Variant 2 switch.
...
const char     CRYPTONOTE_NAME[]                             = "NinjaCoin";
